...
<header>
  ...
  Accounts management - Arellano University Subject Advising - AUSMS 
</header>
...
<body>
	...
	<div class="topnav" id="myTopnav">
       ...
       <a href="accounts-management.php"  style = "background-color: white; color: black;">Accounts Management</a>
    <?php endif; ?>
...
<div class="container">
	<form action = "<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method = "POST">
		Search: <input type="text" name="txtsearch" placeholder="Enter Username or Usertype" style="width: 50%;" >
        <button name="btnsearch" class="btn btn-info">
        	<i class="fas fa-search"></i> Search
        </button>
        <a href="create-account.php" style="float: right;" class = 'btn btn-primary' data-toggle="modal" data-target="#modalCreate">Create new account</a>
	</form>
</div>
...
function buildtable($result) {
	if(mysqli_num_rows($result) > 0){
		...
		echo "<tr>";
		echo "<th>ID #</th><th>User type</th><th>Status</th><th>Created by</th><th>Date created</th><th>Action</th>";
		echo "</tr>";
		// display
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo "<td>";
			echo "<a href = 'update-account.php?username=" . $row['username']. "' class = 'btn btn-success' data-toggle='modal' data-target='#modalUpdate' >Update</a>";
			echo "</td>";
