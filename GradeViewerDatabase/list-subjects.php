<html>
<title>List management - Arellano University Subject Advising - AUSMS </title>
...
<header>
  ...
  List management - Arellano University Subject Advising - AUSMS 
</header>
...
<body>
    ...
    ?>
        ...
        <div class="topnav" id="myTopnav">
            ...
            <a href="students-management.php" style="float: right;" class="active">Return</a>

        <?php if ($_SESSION['usertype'] == "ADMINISTRATOR" || $_SESSION['usertype'] == "PROFESSOR" || $_SESSION['usertype'] == "DEAN") : ?>
       <a style = "background-color: white; color: black;">List Subjects</a>
    <?php endif; ?>
...
$firstrow = true;
    ...
    if ($firstrow) {
        ...
        echo"<a href='create-list.php?studentnumber=" . $account['studentnumber']. "' style='float: right;' class = 'btn btn-success' data-toggle='modal' data-target='#modalCreate'>Add Subject</a> <br> <br> <br>";
            echo "</center>";
        ...
        echo "<tr>";
        echo "<th>Subject Code</th><th>Description</th><th>Unit</th><th>Instructor</th><th>Action</th>";
        echo "</tr>";
        ...
        $firstrow = false;
            ...
            echo "<td>";
                  ...
                  echo "<a href = 'delete-list.php?studentnumber=" . $account['studentnumber'] . "&subject_code=" . $account['subject_code'] . "&grade=" . $account['grade'] . "' class = 'btn btn-danger' data-toggle='modal' data-target='#modalDelete'>Remove</a>";
