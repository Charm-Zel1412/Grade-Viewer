<html>
<title>Students management - Arellano University Subject Advising - AUSMS </title>
...
Students management - Arellano University Subject Advising - AUSMS 
</header>
...
<body>
    ...
    <?php endif; ?>
	  ...
	  <?php if ($_SESSION['usertype'] == "ADMINISTRATOR" || $_SESSION['usertype'] == "DEAN") : ?>
       <a href="students-management.php"  style = "background-color: white; color: black;">Students Management</a>
    <?php endif; ?>
...
<div class="container">
	<form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="POST">
		...
		<a href="create-student.php" style="float: right;" class="btn btn-primary" data-toggle="modal" data-target="#modalCreate">Create new student account</a>
	</form>
</div>
...
function buildtable($result) {
	if(mysqli_num_rows($result) > 0){
		...
		echo "<tr>";
		echo "<th>Student #</th><th>Last name</th><th>First name</th><th>Second name</th><th>Middle name</th><th>Course</th><th>Year level</th><th>Subjects</th><th>Action</th>";
		echo "</tr>";
		// display
		...
		while ($row = mysqli_fetch_array($result)) {
			...
			echo "<td>";
			echo "<a href = 'list-subjects.php?studentnumber=" . $row['studentnumber']. "' class = 'btn btn-default'>Subjects</a>";
			echo "</td>";

			echo "<td>";
			echo "<a href = 'update-student.php?studentnumber=" . $row['studentnumber']. "' class = 'btn btn-success' data-toggle='modal' data-target='#modalUpdate' >Update</a>";
			echo "      ";
			echo "</td>";
